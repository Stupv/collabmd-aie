  ...
  assert.deepEqual(
    ...
    [
      { body: null, headers: null, method: "GET", url: "/app/api/files" },
      {
        ...
        headers: null,
        method: "GET",
        url: "/app/api/file?path=notes%2Ftoday.md",
      },
      {
        body: { content: "# Today\n", path: "notes/today.md" },
        headers: { "Content-Type": "application/json" },
      ...
      },
      {
        ...
        headers: null,
        method: "DELETE",
        url: "/app/api/file?path=notes%2Ftomorrow.md",
      },
      {
        body: { path: "notes/archive" },
        headers: { "Content-Type": "application/json" },
        method: "POST",
...
test("VaultApiClient surfaces API-provided errors", async (t) => {
  ...
  globalThis.fetch = async () =>
    new Response(JSON.stringify({ error: "File already exists", ok: false }), {
      headers: { "Content-Type": "application/json" },
      status: 409,
    });
